...
import static io.mosip.totpbinderservice.util.ErrorConstants.INVALID_REQUEST;
import static io.mosip.totpbinderservice.util.ErrorConstants.UNKNOWN_ERROR;
import static io.mosip.totpbinderservice.util.Constants.UTC_DATETIME_PATTERN;
...
import io.mosip.totpbinderservice.dto.Error;
...
public class ExceptionHandlerAdvice extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity handleExceptions(Exception ex, WebRequest request) {
		...
		if (ex instanceof BindingException) {
			String errorCode = ((BindingException) ex).getErrorCode();
    ...
    private ResponseWrapper getResponseWrapper(List<Error> errors) {
		...
		responseWrapper.setResponseTime(getCurrentUTCDateTime());
    ...
    private static String getCurrentUTCDateTime() {
